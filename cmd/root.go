...
var (
	...
	RootCmd = &cobra.Command{
		Use:   "cast",
		Short: "Cast is a user utility for Fedora atomic images.",
		Long:  "Go Cast Go is a user utility designed to be used for Fedora atomic images.",
		Run: func(cmd *cobra.Command, args []string) {
			...
			if versionFlag {
				fmt.Println(color.MagentaString("Cast") + ": 1.2")
			}
		},
	}
)
